...
class ResNetsWrap(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNetsWrap, self).__init__()
        self.resnet=ResNets(block,num_blocks,num_classes)
...
def resnet20s(num_classes=10,bn=True):
    return ResNetsWrap(BasicBlock, [3, 3, 3], num_classes=num_classes)
